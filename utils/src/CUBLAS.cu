...
int CUBLAS::XGESVDBufferSize(cusolverDnHandle_t handle, int m, int n, double) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnDgesvd_bufferSize(handle, m, n, &lwork) );
  return lwork;
}
template < >
int CUBLAS::XGESVDBufferSize(cusolverDnHandle_t handle, int m, int n, float) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnSgesvd_bufferSize(handle, m, n, &lwork) );
  return lwork;
}
...
CUBLAS::XGEQRFBufferSize(cusolverDnHandle_t handle, int m, int n, double* A_d, int lda) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnDgeqrf_bufferSize(handle, m, n, A_d, lda, &lwork) );
  return lwork;
}
template < >
int
CUBLAS::XGEQRFBufferSize(cusolverDnHandle_t handle, int m, int n, float* A_d, int lda) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnSgeqrf_bufferSize(handle, m, n, A_d, lda, &lwork) );
  return lwork;
}
...
int CUBLAS::XORMQRBufferSize(cusolverDnHandle_t handle, cublasSideMode_t side,
  ...
  int lwork = 0;
  cuSolverErrchk ( cusolverDnDormqr_bufferSize(handle, side, trans, m, n, k, A_d,
...
int CUBLAS::XORMQRBufferSize(cusolverDnHandle_t handle, cublasSideMode_t side,
  ...
  int lwork = 0;
  cuSolverErrchk ( cusolverDnSormqr_bufferSize(handle, side, trans, m, n, k, A_d,
                                               ldA, TAU_d, C_d, ldC, &lwork) );
  return lwork;
}
...
int CUBLAS::XORGQRBufferSize(cusolverDnHandle_t handle, int m, int n, int k,
                            const double* A_d, int ldA, const double* TAU_d) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnDorgqr_bufferSize(handle, m, n, k, A_d, ldA, TAU_d, &lwork) );
  return lwork;
}
template < >
int CUBLAS::XORGQRBufferSize(cusolverDnHandle_t handle, int m, int n, int k,
                            const float* A_d, int ldA, const float* TAU_d) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnSorgqr_bufferSize(handle, m, n, k, A_d, ldA, TAU_d, &lwork) );;
  return lwork;
}
...
CUBLAS::XGETRFBufferSize(cusolverDnHandle_t handle, int m, int n, double* A_d, int ldA) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnDgetrf_bufferSize(handle, m, n, A_d, ldA, &lwork) );
  return lwork;
}
template < >
int
CUBLAS::XGETRFBufferSize(cusolverDnHandle_t handle, int m, int n, float* A_d, int ldA) {
  int lwork = 0;
  cuSolverErrchk ( cusolverDnSgetrf_bufferSize(handle, m, n, A_d, ldA, &lwork) );
  return lwork;
}
...
CUBLAS::XSYEVDXBufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz,
  ...
  int lwork = 0;
  cuSolverErrchk ( cusolverDnDsyevdx_bufferSize(handle, jobz, range, uplo, n,
...
CUBLAS::XSYEVDXBufferSize(cusolverDnHandle_t handle, cusolverEigMode_t jobz,
  ...
  int lwork = 0;
  cuSolverErrchk ( cusolverDnSsyevdx_bufferSize(handle, jobz, range, uplo, n,
                                      A_d, ldA, vL, vU, iL, iU, m, W_d, &lwork) );
  return lwork;
}
